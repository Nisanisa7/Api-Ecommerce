...
const sendEmail = (email, userName, token) =>{
    ...
    transporter.sendMail({
        ...
        subject: "Verify Your Email Address for Blanja", // Subject line
        html: `<!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
        ...
        <body>
            <div class="wrapper">
                <div class="container">
                    ...
                    <a href="https://ecommercenisa.herokuapp.com/v1/user/verification/${token}"><input type="button" value="VERIFY ACOOUNT" class="button"></a>
                </div>
            </div>
        </body>
        </html>`, // html body
